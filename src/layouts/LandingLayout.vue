    ...
    <v-app-bar flat height="80">
      <v-container class="py-0 px-0 px-sm-2 fill-height">
        <router-link to="/dashboard/analytics" class="d-flex align-center text-decoration-none mr-2">
          ...
          <img src="https://kangufiles.nyc3.digitaloceanspaces.com/kangu/logoNuevoKangu.png" height="36" />
        </router-link>
        ...
        <div class="d-none d-md-block">
          ...
          <!--  to="/auth/signin" propidad inicial del boton inferior -->  
          <!-- <v-btn text class="mx-1" @click="salir()">
            Salir
          </v-btn> -->
        </div>
        <!--  to="/auth/signup" propidad inicial del boton inferior -->
        <v-btn outlined large @click="login()">
          Ingresar
        </v-btn>
      </v-container>
    </v-app-bar>
