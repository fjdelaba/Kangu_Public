      ...
      <div>
        ...
        <v-expansion-panels v-model="panel" multiple class="mt-3">
          ...
          <v-expansion-panel v-model="panel" multiple class="mt-3">
            <v-expansion-panel-header class="title">Contactos</v-expansion-panel-header>
            <v-expansion-panel-content class="body-2" >
              ...
              >
                ...
                <v-card-text>
                  ...
                  >
                    <center>
                      <v-btn color="primary" small @click="editarContacto(item)">Editar</v-btn>
                    </center>
        ...
        <!--!> DIALOGO PARA DESHABILITAR USUARIO <-->
      </div>
      <v-row justify="center">
        <v-dialog
